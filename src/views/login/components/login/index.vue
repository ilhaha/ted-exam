        ...
        <div class="login-right">
          ...
          <a-tabs v-else v-model:activeKey="activeTab" class="login-right__form">
            <a-tab-pane key="1" title="账号登录">
              <AccountLogin v-if="activeTab === '1'" />
            </a-tab-pane>
            <a-tab-pane key="2" title="手机号登录">
              <PhoneLogin v-if="activeTab === '2'" />
            </a-tab-pane>
          </a-tabs>
          <!-- <div class="login-right__oauth">
            <a-radio-group v-model:value="activeTab" class="login-right__radio">
              <a-radio value="1">考生登录</a-radio>
              <a-radio value="2">监考登录</a-radio>
            </a-radio-group>
          </div> -->
        </div>
...
import AccountLogin from '../account/index.vue'
import PhoneLogin from '../phone/index.vue'
import EmailLogin from '../email/index.vue'
